...
<img src="PycharmProjects/fast_api_cutout/Docker/MODNet/doc/gif/homepage_demo.gif" width="100%">
...
<img src="PycharmProjects/fast_api_cutout/Docker/MODNet/doc/gif/commercial_image_matting_website.gif" width='100%'>
...
If you have an Ubuntu system, we recommend you to try the [offline demo](PycharmProjects/fast_api_cutout/Docker/MODNet/demo/video_matting/webcam) to get a higher *fps*. Otherwise, you can access the [online Colab demo](https://colab.research.google.com/drive/1Pt3KDSc2q7WxFvekCnCLD8P0gBEbxm6J?usp=sharing).  
We also provide an [offline demo](PycharmProjects/fast_api_cutout/Docker/MODNet/demo/video_matting/custom) that allows you to process custom videos.
...
You can convert the pre-trained MODNet to an ONNX model by using [this code](PycharmProjects/fast_api_cutout/Docker/MODNet/onnx) (provided by [@manthan3C273](https://github.com/manthan3C273)). You can also try [this Colab demo](https://colab.research.google.com/drive/1P3cWtg8fnmu9karZHYDAtmm1vj1rgA-f?usp=sharing) for MODNet image matting (ONNX version).

- **TorchScript Version of MODNet**  
You can convert the pre-trained MODNet to an TorchScript model by using [this code](PycharmProjects/fast_api_cutout/Docker/MODNet/torchscript) (provided by [@yarkable](https://github.com/yarkable)). 
...
## Code
We provide the [code](PycharmProjects/fast_api_cutout/Docker/MODNet/src/trainer.py) of MODNet training iteration, including:
